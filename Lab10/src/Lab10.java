...
public class Lab10 {
    ...
    public static void main (String ... args) {
        ...
        System.out.println("(Non Recursive) Target -7 " + (targetIndex < 0 ? "was not found and should be at index" + targetIndex : ("was found at index " + targetIndex)));
        targetIndex = binarySearch(arraybinary, 42);
        System.out.println("(Non Recursive) Target 42 " + (targetIndex < 0 ? "was not found and should be at index " + targetIndex : ("was found at index " + targetIndex)));
